...
function createHeader() {
  ...
  const listifyIcon = renderIcon(
    ListifyBrandIcon,
    'Listify brand icon image',
    'listifyIcon',
  );
  ...
  const profileIcon = renderIcon(
    CustomerIcon,
    'Image of a user profile icon',
    'userProfileIcon',
  );
...
function createSidePanel() {
  ...
  const inboxTab = createSidebarViewTab(
    TrayFullIcon,
    'Icon of a full inbox',
    'All Tasks',
    'sidebarTabViewIcon',
  );
  sideItemsArray.push(inboxTab);
  // View section today tab
  const todayTab = createSidebarViewTab(
    TodayIcon,
    'Icon of a calendar today',
    'Today',
    'sidebarTabViewIcon',
  );
  sideItemsArray.push(todayTab);
  // View section week tab
  const weekTab = createSidebarViewTab(
    MonthIcon,
  ...
  const favoritesTab = createSidebarViewTab(
    StarIcon,
    'Icon of a start icon',
    'Favorites',
    'sidebarTabViewIcon',
  );
  sideItemsArray.push(favoritesTab);
  // Add completed tasks section
  const completeTab = createSidebarViewTab(
    CheckAll,
    'Icon of a check mark icon',
    'Completed',
    'sidebarTabViewIcon',
  );
...
export {
  createHeader, createSidePanel, createFooter, createListifyUI,
};
